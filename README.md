...
```
$ git clone https://github.com/ddhartma/Deep-Reinforcement-Learning-Theory-Monte-Carlo-Methods.git
```

- Change Directory
```
$ cd Deep-Reinforcement-Learning-Theory-Monte-Carlo-Methods
```

- Create a new Python environment, e.g. drl_env. Inside Git Bash (Terminal) write:
```
